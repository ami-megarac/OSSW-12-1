...
#define GET_ROUTING_TYPE(x)	((x >> 14) & 0x3)
...
// size offset
#define MCTP_TX_CMD_OFFSET	0
#define MCTP_RX_CMD_OFFSET	(MCTP_TX_CMD_OFFSET + MCTP_TX_CMD_SIZE)
#define MCTP_TX_DATA_OFFSET	(MCTP_RX_CMD_OFFSET + MCTP_RX_CMD_SIZE)
#define MCTP_RX_DATA_OFFSET	(MCTP_TX_DATA_OFFSET + MCTP_TX_DATA_SIZE)
#define MCTP_RX_FIFO_OFFSET	(MCTP_RX_DATA_OFFSET + MCTP_RX_DATA_SIZE)

// Buffer Size
#define MCTP_TX_CMD_SIZE	512
#define MCTP_RX_CMD_SIZE	512
#define MCTP_TX_DATA_SIZE	1024
#define MCTP_RX_DATA_SIZE	4096
#define MCTP_RX_FIFO_SIZE	4096
