...
#define HID_INTERVAL_HIGH_SPEED	(1) // range: 1 ~ 16. unit: 2^(X-1) * 125 us.
#define HID_INTERVAL_FULL_SPEED	(1) // range: 1 ~ 255. unit: ms.
#define HID_INTERVAL_LOW_SPEED	(10) // range: 10 ~ 255. unit: ms.
#if defined SOC_PILOT_IV
// PILOT SOC.
#define HID_INTERVAL	(HID_INTERVAL_HIGH_SPEED)
#else
// AST SOC.
#define HID_INTERVAL	(HID_INTERVAL_LOW_SPEED)
...
static int Interval = HID_INTERVAL;
