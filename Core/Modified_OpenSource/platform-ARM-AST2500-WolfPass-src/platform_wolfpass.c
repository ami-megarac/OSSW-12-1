...
#define AST_SCU_MULTI_PIN_PWM0_PWM7 	0x000000FF /* bit 7-0 */
...
int __init init_module(void)
{
	...
	reg |= AST_SCU_MULTI_PIN_MAC1_MDIO | AST_SCU_MULTI_PIN_MAC1_MDC | AST_SCU_MULTI_PIN_PWM0_PWM7;
    ...
    reg |= 0xfe000000; 									 //Enable UART 4. //Not enable NCTS4, this Pin is for GPIO funcion to output NMI to PCH 
    iowrite32(reg, (void __iomem*)AST_SCU_VA_BASE + 0x80);   

	reg = ioread32((void __iomem*)AST_SCU_VA_BASE + 0x84); 
	reg |= 0x00ff0000;                       			 //Enable UART 1.
