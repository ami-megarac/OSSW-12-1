--- u-boot-2013.07/drivers/spiflash/spiflash.c	2017-08-15 15:17:24.868884473 -0400
+++ uboot/drivers/spiflash/spiflash.c	2017-08-15 10:35:11.296709797 -0400
@@ -0,0 +1,539 @@
+/*
...
+unsigned char ractrends_spiflash_address_mode[CONFIG_SYS_MAX_FLASH_BANKS];
+unsigned char total_active_spi_banks = 0;
+
...
+
+		ractrends_spiflash_address_mode [bank] = spi_info.address32;
+
+		total_active_spi_banks = bank;
+	
+		sector=0;
...
+		private[bank].iomode_read  = private[bank].ctrl_drv->fast_read;
+		private[bank].iomode_write = private[bank].ctrl_drv->fast_write;
